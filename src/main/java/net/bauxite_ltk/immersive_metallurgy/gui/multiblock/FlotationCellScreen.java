...
import net.bauxite_ltk.immersive_metallurgy.gui.info.FlotationCellAddFluidInfoArea;
...
public class FlotationCellScreen extends IEContainerScreen<FlotationCellMenu> {
    ...
    private static final ResourceLocation TANK = IMUtils.modRL("flotation_cell/tank_overlay");
    private static final ResourceLocation SMALL_TANK = IMUtils.modRL("flotation_cell/small_tank_overlay");
    private static final ResourceLocation BIG_TANK = IMUtils.modRL("flotation_cell/big_tank_overlay");
    public static final ResourceLocation ADD_TANK = IMUtils.modRL("flotation_cell/add_tank_overlay");

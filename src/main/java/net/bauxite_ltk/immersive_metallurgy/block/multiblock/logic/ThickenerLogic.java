...
import net.bauxite_ltk.immersive_metallurgy.block.multiblock.shapes.ThickenerShapes;
...
public class ThickenerLogic implements
    ...
    private void enqueueProcesses(State state, Level level) {
        ...
        IMMultiblockProcessInMachine<ThickenerRecipe> process = new IMMultiblockProcessInMachine<ThickenerRecipe>(recipe);

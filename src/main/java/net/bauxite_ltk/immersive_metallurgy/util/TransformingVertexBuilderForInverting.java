...
public class TransformingVertexBuilderForInverting extends VertexConsumerWrapper {
    ...
    public TransformingVertexBuilderForInverting(VertexConsumer base, PoseStack transform)
    {
        super(base);
        this.transform = transform;
    }

    public TransformingVertexBuilderForInverting(VertexConsumer base)
    {
        this(base, new PoseStack());
    }

    public TransformingVertexBuilderForInverting(MultiBufferSource buffer, RenderType type, PoseStack transform)
    {
        this(buffer.getBuffer(type), transform);
    }

    public TransformingVertexBuilderForInverting(MultiBufferSource buffer, RenderType type)
    {
    ...
    public void endVertex(){
        if(this.parent instanceof InvertingVertexBuffer buffer){
            buffer.endVertex();
        }
    }

...
public class BallMillCategory extends IERecipeCategory<BallMillRecipe> {
    ...
    public BallMillCategory(IGuiHelper helper) {
        super(helper, JEIRecipeTypes.BALL_MILL, "block.immersive_metallurgy.ball_mill");
        ResourceLocation background = IMUtils.modRL("textures/gui/ball_mill.png");
        setBackground(helper.createDrawable(background, 6, 9, 155-5, 73-8));
        setIcon(IMMultiblockLogic.BALL_MILL.iconStack());
